...
@section('page-heading', 'Chọn lớp học để quản lý bài học')
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    <i class="fas fa-graduation-cap mr-2"></i> Chọn lớp học để quản lý bài học
                </h3>
            ...
            @forelse($lopHocs as $lopHoc)
                <div class="bg-white shadow rounded-lg overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <a href="{{ route('giao-vien.bai-hoc.index', ['lop_hoc_id' => $lopHoc->id]) }}" class="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
