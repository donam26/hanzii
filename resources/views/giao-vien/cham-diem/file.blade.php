...
<div class="container mx-auto px-4">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Chấm điểm bài tập file</h1>
        <div class="mt-1 flex items-center">
            ...
            <span class="text-gray-600">Chấm điểm bài tập file</span>
        </div>
    </div>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <ul class="space-y-2 text-sm text-gray-700">
                                <li class="flex items-center">
                                    ...
                                    Tải xuống và kiểm tra file của học viên
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-4 w-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
                    <div class="px-4 py-3 border-b border-gray-200 bg-gray-50">
                        <h3 class="text-sm font-medium text-gray-900 flex items-center">
                            ...
                            File bài tập của học viên
                        </h3>
                    </div>
                    <div class="px-4 py-5 sm:p-6">
                        @if($baiNop->noi_dung)
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-700 mb-2">Ghi chú từ học viên:</h4>
                                ...
                                <div class="border border-gray-200 rounded-md overflow-hidden">
                                    <div class="px-4 py-3 flex justify-between items-center bg-gray-50 border-b border-gray-200">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('giao-vien.cham-diem.download', $baiNop->id) }}" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                                <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @else
                            <div class="mt-4 text-center py-8">
                                ...
                                <p class="mt-2 text-sm text-gray-500">Không có file đính kèm</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2">
                        <div class="mb-4">
                            ...
                            <textarea id="phan_hoi" name="phan_hoi" rows="5" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>{{ old('phan_hoi', $baiNop->phan_hoi) }}</textarea>
                            @error('phan_hoi')
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="number" id="diem" name="diem" min="0" max="10" step="0.1" value="{{ old('diem', $baiNop->diem) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                            @error('diem')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <ul class="space-y-1 text-sm text-gray-700">
                                    <li class="flex items-start">
                                        ...
                                        Đúng định dạng và yêu cầu: 3 điểm
                                    </li>
                                    <li class="flex items-start">
                                        <svg class="h-4 w-4 mr-2 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        Chất lượng nội dung: 5 điểm
                                    </li>
                                    <li class="flex items-start">
                                        <svg class="h-4 w-4 mr-2 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        Sáng tạo và trình bày: 2 điểm
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            <p>Sau khi chấm điểm, học viên sẽ nhận được thông báo qua email.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
