...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Thống kê thanh toán theo tháng</h1>
        <div>
            <a href="{{ route('admin.thanh-toan.thong-ke-ngay') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-calendar-day fa-sm text-white-50"></i> Thống kê theo ngày
            </a>
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Lọc theo năm</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.thanh-toan.thong-ke-thang') }}" method="GET" class="form-inline">
                        <div class="form-group mb-2 mr-2">
                            <label for="nam" class="sr-only">Năm</label>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Số lượng thanh toán theo tháng</h6>
                </div>
                <div class="card-body">
                    <div class="chart-pie">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Chi tiết thanh toán theo tháng</h6>
                </div>
                <div class="card-body">
