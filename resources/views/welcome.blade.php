        ...
        <section class="hero-pattern py-20">
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div class="md:w-1/2">
                        <img src="https://source.unsplash.com/random/600x400/?chinese,classroom" alt="Lớp học tiếng Trung" class="rounded-lg shadow-xl">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="khoa-hoc" class="py-20 bg-gray-50">
            <div class="container mx-auto px-4">
                ...
                <div class="text-center mt-10">
                    <a href="#" class="px-6 py-3 border border-red-600 text-red-600 rounded-lg hover:bg-red-600 hover:text-white transition duration-300">
                        Xem tất cả khóa học
                    </a>
                </div>
            </div>
                    ...
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" id="name" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-red-500">
                            </div>
                            <div>
                                <label for="email" class="block text-gray-700 mb-2">Email</label>
                                <input type="email" id="email" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-red-500">
                            </div>
                        </div>
                        <div class="mb-6">
                            <label for="subject" class="block text-gray-700 mb-2">Chủ đề</label>
                            <input type="text" id="subject" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-red-500">
                        </div>
                        <div class="mb-6">
                            <label for="message" class="block text-gray-700 mb-2">Tin nhắn</label>
                            <textarea id="message" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-red-500"></textarea>
                        </div>
